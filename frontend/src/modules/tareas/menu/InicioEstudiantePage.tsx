...
const InicioEstudiantePage = () => {
  ...
  if (!user || user.tipo !== 'estudiante') {
    return <div style={{ minHeight: '100vh', minWidth: '100vw', background: '#928d8d', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: 'red' }}>Acceso denegado. Solo estudiantes pueden ver esta página.</div>;
  }
